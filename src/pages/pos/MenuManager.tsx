    ...
    <div>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          <div className="rounded-md border border-primary/30 bg-card/70 p-3">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-3">
                      ...
                      <div className="text-xs text-muted-foreground flex items-center gap-2">
                        ...
                        <span className={cn(
                          'rounded-full border px-2 py-0.5',
                          linkedRecipe && !readyToSellLinked ? 'border-primary/35 bg-primary/12 text-primary' : 'border-muted-foreground/20'
                        )}>
                          {linkedRecipe && !readyToSellLinked ? 'Recipe Linked' : linkedRecipe && readyToSellLinked ? 'Recipe (Ignored)' : 'No Recipe'}
                        </span>
                        <span className={cn(
                          'rounded-full border px-2 py-0.5',
                          readyToSellLinked ? 'border-primary/35 bg-primary/12 text-primary' : 'border-muted-foreground/20'
                        )}>
      ...
      <Dialog open={showModal} onOpenChange={setShowModal}>
        <DialogContent className="max-w-lg max-h-[80vh] overflow-auto">
          ...
          <div className="grid gap-3">
            ...
            {hasReadySaleMatch ? (
              <div className="rounded-md border border-primary/35 bg-primary/12 px-3 py-2 text-xs text-primary">
