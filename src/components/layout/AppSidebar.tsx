...
const backOfficeItems: NavItemType[] = [
  ...
  { id: 'back-recipes', title: 'Recipes', url: '/app/manufacturing/recipes', icon: ChefHat, permission: 'recordBatchProduction' },
  { id: 'back-batch-history', title: 'Batch History', url: '/app/manufacturing/history', icon: Boxes, permission: 'recordBatchProduction' },
  ...
  { id: 'back-audit', title: 'Audit Trail', url: '/app/audit-dashboard', icon: ShieldCheck, permission: 'viewReports', roles: ['owner', 'manager', 'front_supervisor'] },
