...
BEGIN
  ...
  -- Strict rule: stock users cannot run the count.
  -- 1) If a valid under_brand_staff supervisor is passed, enforce role.
  -- 2) Otherwise allow brand owner auth context as supervisor fallback.
